      ...
      <nav class="site-header navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <router-link class="nav-link" to="/list">Product</router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link" to="/list">Features</router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link" to="/list">Enterprise</router-link>
            </li>
          </ul>
          <div class="mr-3 d-flex">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right p-3" style="min-width: 300px"
                ...
                <router-link to="/cart"><button class="btn btn-primary btn-block"><i class="fa fa-cart-plus" aria-hidden="true"></i> 結帳去</button></router-link>
              </div>
            </div>
          </div>
        </div>
