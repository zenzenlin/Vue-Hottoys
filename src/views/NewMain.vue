      ...
      <div class="container-fluid p-0">
        ...
        <div class="container">
          <div class="py-3">
            ...
            <p>Find the best selection of Hot Toys Wonder Woman Sixth Scale Figures at Sideshow. Based on the DC Comics superhero, the Hot Toys Wonder Woman figures present film accurate collectibles featuring the stunning likeness of Gal Gadot. Check out our full line of Wonder Woman Figures.</p>
          </div>
        </div>
      </div>
      <div class="container marketing">
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5 order-md-1">
            <img class="main-img-style img2" style="max-height:310px" alt="">
            <!-- <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"/><text x="50%" y="50%" fill="#aaa" dy=".3em">500x500</text></svg> -->
          </div>
        </div>
        <hr class="featurette-divider">
        <div class="row featurette " style="margin-bottom:80px">
          ...
          <div class="col-md-5">
            <img class="main-img-style img3" style="max-height:310px" alt="">
            <!-- <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"/><text x="50%" y="50%" fill="#aaa" dy=".3em">500x500</text></svg> -->
          </div>
        </div>
        <!-- <hr class="featurette-divider margin-bottom-no"> -->
        <!-- /END THE FEATURETTES -->
      </div><!-- /.container -->
    </main>
  </div>
